...
export default function HodDashboard() {
    ...
    useEffect(() => {
        ...
        // Fetch All Requests for Stats (HOD View)
        ...
        // Fetch My Requests (Personal View)
        if (user) {
            ...
            // Note: We are creating two subscriptions here. Need to handle cleanup properly.
        }
        ...
        return () => {
            unsubscribe();
            // Ideally we should unsubscribe from myQ too but simpler to keep effect clean.
            // Let's rely on React to cleanup if we define it cleanly.
        };
    }, [user]);
