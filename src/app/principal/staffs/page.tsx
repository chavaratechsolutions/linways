...
import { Users, AlertCircle, Calendar, Pencil, Search, ArrowUpDown, ArrowUp, ArrowDown, Phone, MapPin, Briefcase } from "lucide-react";
                ...
                <div className="grid grid-cols-1 gap-4 xl:hidden">
                    {loading ? (
                        ...
                        sortedAndFilteredStaffs.map((staff) => (
                            <Link href={`/principal/staffs/${staff.id}`} key={staff.id} className="block">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {loading ? (
                                    ...
                                    sortedAndFilteredStaffs.map((staff, index) => (
                                        <tr key={staff.id} className="hover:bg-gray-50 transition-colors cursor-pointer" onClick={() => window.location.href = `/principal/staffs/${staff.id}`}>
