...
import { ArrowLeft, User, Mail, Briefcase, Calendar, CheckCircle2, Clock, XCircle, FileText, CalendarClock, GraduationCap } from "lucide-react";
        ...
        return (
            <DashboardLayout allowedRole="dir">
                <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
                    ...
                    <Link href="/director/staffs" className="text-blue-600 hover:underline">
        ...
        <DashboardLayout allowedRole="dir">
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    <Link href="/director/staffs" className="p-2 -ml-2 hover:bg-gray-100 rounded-full transition-colors">
