                ...
                <div className="grid grid-cols-1 gap-4 xl:hidden">
                    {loading ? (
                        ...
                        sortedAndFilteredStaffs.map((staff) => (
                            <Link href={`/director/staffs/${staff.id}`} key={staff.id} className="block">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {loading ? (
                                    ...
                                    sortedAndFilteredStaffs.map((staff, index) => (
                                        <tr key={staff.id} className="hover:bg-gray-50 transition-colors cursor-pointer text-left" onClick={() => window.location.href = `/director/staffs/${staff.id}`}>
