    ...
    return (
        <DashboardLayout allowedRole="dir">
            <div className="space-y-6">
                <div>
                    <h1 className="text-xl md:text-2xl font-bold text-gray-900">Director Dashboard</h1>
                    <p className="text-sm text-gray-500">Welcome to the HR Management System director portal.</p>
                </div>
