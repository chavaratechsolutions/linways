...
export default function AdminDashboard() {
    ...
    const statCards = [
        { name: "Total Staff", value: loading ? "..." : stats.totalStaff, icon: Users, color: "text-purple-600", bg: "bg-purple-100", href: "/admin/staffs" },
        { name: "Pending", value: loading ? "..." : stats.pendingLeaves, icon: Clock, color: "text-yellow-600", bg: "bg-yellow-100", href: "/admin/requests?status=Pending" },
        { name: "Approved", value: loading ? "..." : stats.approvedLeaves, icon: CheckCircle, color: "text-green-600", bg: "bg-green-100", href: "/admin/requests?status=Approved" },
        { name: "Total Requests", value: loading ? "..." : stats.totalRequests, icon: ClipboardList, color: "text-blue-600", bg: "bg-blue-100", href: "/admin/requests?status=All" },
    ];
        ...
        <DashboardLayout allowedRole="admin">
            <div className="space-y-6">
                <div>
                    ...
                    <p className="text-sm text-gray-500">Welcome to the HR Management System administrative portal.</p>
                </div>
