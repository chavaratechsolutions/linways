                        ...
                        {fetchingUsers ? (
                            ...
                            <select
                                ...
                                onChange={(e) => {
                                    ...
                                    const restrict = (formData.type === "Compensatory Leave" || formData.type === "Vacation Leave") && 
                                                     (user?.role === "staff" || user?.role === "hod");
                                    if (restrict) {
                                        setFormData(prev => ({ ...prev, session: "Full Day" }));
                                    }
                                }}
                    ...
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) => {
                                    ...
                                    const restrict = (newType === "Compensatory Leave" || newType === "Vacation Leave") && 
                                                     (selectedUser?.role === "staff" || selectedUser?.role === "hod");
                                    setFormData({ 
                                        ...formData, 
                                        type: newType,
                                        session: restrict ? "Full Day" : formData.session,
                                        toDate: (!restrict && formData.session !== "Full Day") ? formData.fromDate : formData.toDate
                                    });
                                }}
                            >
                        ...
                        <div>
                            ...
                            >
                                ...
                                {(!(formData.type === "Compensatory Leave" || formData.type === "Vacation Leave") || (selectedUser?.role !== "staff" && selectedUser?.role !== "hod")) && (
                                    <>
